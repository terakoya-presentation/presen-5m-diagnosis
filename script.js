const axes = [
  {
    ...
    label: "人",
    comment: [
      "聞き手の関心や判断基準をもう少し具体化すると、相手に合わせた伝え方がしやすくなります。"
    ]
  },
  {
    id: "machine",
    ...
    label: "設備",
    comment: [
      "発表環境や表示条件を事前に確認すると、内容以外のつまずきで伝わりにくくなるリスクを減らせます。"
    ]
  },
  {
    id: "material",
    ...
    label: "資料",
    comment: [
      "1枚ごとに一番伝えたいことを絞ると、聞き手がどこを見ればよいか分かりやすくなります。"
    ]
  },
  {
    id: "method",
    ...
    label: "伝え方",
    comment: [
      "結論から次の行動までの流れを整えると、聞き手が納得して判断しやすくなります。"
    ]
  },
  {
    id: "mind",
    ...
    label: "心理",
    comment: [
      "緊張や不安で主張が曖昧になりすぎないよう、伝える目的を先に整理しておくと安心です。"
    ]
  }
];
...
function getOverallComment(score) {
  return "大きな偏りは少なめです。次は、目的や聞き手に合わせてさらに伝わりやすく整えていきましょう。";
}
